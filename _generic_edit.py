...
grammarCfg.cmd.map = Item(
    {
        ...
        "delete line": Key("home, s-end, del"),  # @IgnorePep8
        "backspace [<n>]": release + Key("backspace:%(n)d"),

        "right click": release + Key("apps"),
        ...
        "redo": release + Key("cs-z"),
        "redo <n> [times]": release + Key("cs-z:%(n)d"),
...
grammar = Grammar("Generic edit", context=AppContext(executable="idea64"))
